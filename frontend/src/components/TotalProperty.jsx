...
const TotalProperty = () => {
  ...
  `https://blog-backend-6s9k.onrender.com/api/v1/blog/get-own-blogs`,
  { withCredentials: true }
    ...
    const getTotalComments = async()=>{
        try {
          const res = await axios.get(
  `https://blog-backend-6s9k.onrender.com/api/v1/comment/my-blogs/comments`,
  { withCredentials: true }
);
          if(res.data.success){
    ...
    const getTotalLikes = async()=>{
      try {
        const res = await axios.get(
  `https://blog-backend-6s9k.onrender.com/api/v1/blog/my-blogs/likes`,
  { withCredentials: true }
);
        if(res.data.success){
